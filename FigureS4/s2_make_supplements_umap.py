...
color_dict['d2_shifted'] = "#62205fff"
color_dict['d3_shifted'] = "#b9563fff"
color_dict['d5_shifted'] = "#a9845bff"
color_dict['e14_shifted'] = "#ecb27dff"

color_dict['hd_D2_shifted'] = "#341648ff"
color_dict['hd_D3_shifted'] = "#591d08ff"
color_dict['ld_D2_shifted'] = "#9f2d55ff"
color_dict['ld_D3_shifted'] = "#86201eff"

color_dict['3'] = "#078d84ff"
color_dict['4'] = "#f7b817ff"
color_dict['5'] = "#e27d26ff"
color_dict['7'] = "#c63735ff"
...
for celltype in celltypes:
    ...
    plt.tight_layout()
    plt.savefig('ma/s2_' +  str(celltype) + '_supp.pdf')
...
for celltype in celltypes:
    ...
    for comp_degree in comp_degrees:
        ...
        sc.pl.umap(lat_comp,color = 'compare_umap', palette=palette_demuth,ax = axes[1,current_axes],show= False)
    plt.tight_layout()
    plt.savefig('pr/s2_' + str(celltype) + '_supp.pdf')
