...
celltypes = ['CD4+_T_Cells','CD8+_T_Cells','B_Cells','Classical_Monocytes','NK_Cells','Non_Classical_Monocytes','Immature_Neutrophils','Neutrophils']
for celltype in celltypes:
    ...
    lat_adata_hamster_shifted.obs['dataset'] = 'humanized hamsterPR'
    ...
    r2_value_hamster_hamster_humanized = model.reg_mean_plot(
        decoded_test,
        axis_keys={"x": "humanized hamster", "y": "hamsterPR"},
        gene_list=diff_genes[:10],
        labels={"x": "humanized hamster", "y": "hamsterPR"},
        show = True,
        legend=False,
